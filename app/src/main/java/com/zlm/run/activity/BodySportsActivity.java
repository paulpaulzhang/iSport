...
public class BodySportsActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_body_sports);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.cv_1:
                ...
                intent1.putExtra("res_id", "nsfbjfjc");
            ...
            case R.id.cv_3:
                ...
                intent3.putExtra("res_id", "qhqjneice");
